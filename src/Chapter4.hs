...
reverseTree (Branch a l r) = Branch a (reverseTree r) (reverseTree l)


treeToList :: Tree a -> [a] 
treeToList Leaf = []
treeToList (Branch a l r) = a : (treeToList l ++ treeToList r)

insert :: Ord a => a -> Tree a -> Tree a 
insert a Leaf = Branch a Leaf Leaf
insert a (Branch b l r) | a > b = Branch b (insert a l) r
insert a (Branch b l r) = Branch b l (insert a r)
